...
import com.vrmux.R;
import com.vrmux.terminal.EmulatorDebug;
import com.vrmux.terminal.TerminalSession;
import com.vrmux.terminal.TerminalSession.SessionChangedCallback;
...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/com.vrmux/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "com.vrmux.service_stop";
    private static final String ACTION_LOCK_WAKE = "com.vrmux.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "com.vrmux.service_wake_unlock";
    /** Intent action to launch a new terminal session. Executed from TermuxWidgetProvider. */
    public static final String ACTION_EXECUTE = "com.vrmux.service_execute";

    public static final String EXTRA_ARGUMENTS = "com.vrmux.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "com.vrmux.execute.cwd";
    private static final String EXTRA_EXECUTE_IN_BACKGROUND = "com.vrmux.execute.background";
